...
import type {AlipushIOSConfig, AlipushConfig} from './shared';

const ALIYUN_POD_SOURCE = `source 'https://github.com/aliyun/aliyun-specs.git'`;

const withAlipushIOSConfig: ConfigPlugin<AlipushConfig> = (config, {ios}) => {
...
const withAliyunAppConfig: ConfigPlugin<AlipushIOSConfig> = (
  config,
  {appKey, appSecret},
) => {
...
export default withAlipushIOSConfig;
